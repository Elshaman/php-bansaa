                                ...
                                <div class="row"><!--row 3 -->
                                    ...
                                    <div class="col p-3">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio"  name="genera_evidencia" id="radio-si" value="si"
                                                   checked>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio"  name="genera_evidencia" id="radio-no" value="no">
